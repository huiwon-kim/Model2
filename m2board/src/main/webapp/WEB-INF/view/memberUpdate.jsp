...
<tr>
	<td>NAME</td>
	<td> <input type="text" id="memberName" name="memberName" value="${loginMember.memberName}"></td>
</tr>

<tr>
	<td>GENDER</td>
	<td> <input type="text" id="memberGender" name="memberGender" value="${loginMember.memberGender}"> </td>
	<td> <input type="radio" id="male" name="memberGender">남성
	 <input type="radio" id="female" name="memberGender">여성</td>
</tr>
<tr>
			<th> ADDRESS </th>
